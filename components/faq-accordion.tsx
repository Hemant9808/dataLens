...
const data = [
  ...
  },
  {
    ...
    content:
      "Yes, we offer fully customisable reports to fit your specific needs and data. Reach out to us at info@datalens.ai for a quote.",
  },
  {
    id: 6,
    name: "Can I get a report with my company’s branding?",
    content:
      "Absolutely! We offer a full carte of branding options. Reach out to us at info@datalens.ai for a quote.",
  },
  {
    id: 7,
    name: "How can I reach out to support?",
    content:
      "Reach out to us at info@datalens.ai. We will get back to you as soon as possible.",
  },
];
