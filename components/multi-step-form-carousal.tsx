  ...
  const carouselConfig = [
    {
      ...
      content: (
        <div className="font-light">
          By using DataLens (accessible at DataLens.ai), you acknowledge
          ...
          uploading files to DataLens, you grant us a non-exclusive,
          ...
          DataLens, its founders, and affiliates shall not be liable for any
          ...
          acceptance of the new terms. By using DataLens or any of our other
